...
if [ ! -f "Mapped_Data/hisat2_out/""$file2"".bam" ]; then
        ...
        hisat2 -p 4 --dta -x /scratch/tms51355/Taylor2025/TS_June2025Sequencing/maize_tran -U "Mapped_Data/hisat2_out/""$file2"".fastq.gz" | samtools view -bS -> "Mapped_Data/hisat2_out/""$file2""_unsorted.bam"
