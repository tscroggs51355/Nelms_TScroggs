#!/bin/bash
#SBATCH --job-name=UMICounts_RC1November2024
#SBATCH --partition=batch
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --mem=70gb
#SBATCH --time=72:00:00
#SBATCH --output=UMICounts_RC1November2024_stringtie2.%j.out
#SBATCH --error=UMICounts_RC1November2024_stringtie2.%j.err
